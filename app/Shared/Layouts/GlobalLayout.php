...
<head>
    ...
    <!-- DataTables RowGroup Extension (Optional) -->
...
<body class="bg-gray-100 text-gray-900">
    ...
    <?php require_once __DIR__ . '/../Partials/GlobalHeader.php';  // Corrected path
 ?>
    </header>
    <!-- END HEADER -->
    ...
    <aside class="hidden sm:flex fixed top-12 bottom-0 left-0 w-20 bg-gray-800 z-40 flex-col items-center overflow-auto">
    <?php require_once __DIR__ . '/../Partials/GlobalAside.php';  // Corrected path?>        
    </aside>
    <!-- END ASIDE -->
